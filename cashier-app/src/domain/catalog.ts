 ...
 * then persisted to localStorage and mutable via Products page.
 *
 * Each tenant gets a thematic catalog so the multi-tenancy is obvious:
 *   - Myntra    → fashion/apparel
 *   - Flipkart  → electronics + accessories
 *   - Walmart   → grocery/household
 */
