/**
 * Feedback components — ToastStack + ConfirmDialog.
 * ToastStack subscribes to ToastContext and renders any active toasts.
 * ConfirmDialog is a simple "yes/no" modal built on the shared Modal.
 */
