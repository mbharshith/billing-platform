...
const LiveOrdersPage         = namedFrom(() => import('./pages/admin/live-orders'),      'LiveOrdersPage');
const IngredientsPage        = named('IngredientsPage');
const RecipesPage            = namedFrom(() => import('./pages/admin/recipes'),          'RecipesPage');
const SuppliersPage          = named('SuppliersPage');
const PurchaseOrdersPage     = namedFrom(() => import('./pages/admin/purchase-orders'),   'PurchaseOrdersPage');
