...
const CATEGORY_META: Record<ProductCategory, { label: string; icon: IconName }> = {
  ...
  Biryani:         { label: 'Biryani',         icon: 'spark' },
  'Rice Items':    { label: 'Rice Items',      icon: 'store' },
  Gravies:         { label: 'Gravies',         icon: 'chart' },
  'Parotta & Roti': { label: 'Parotta & Roti', icon: 'bag' },
  Rolls:           { label: 'Rolls',           icon: 'bag' },
  Kebabs:          { label: 'Kebabs',          icon: 'bag' },
  'Tandoori Items': { label: 'Tandoori',       icon: 'chart' },
};
